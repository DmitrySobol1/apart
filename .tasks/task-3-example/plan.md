# Task-3 — Admin Ingest “Since Date” (Final Implementation Plan)
...
- E2E/manual:
  - `curl -u admin:pass -X POST \
    ...
    -d '{"since":"2025-06-01T00:00:00Z","rescanLatest":150}'`
  - Confirm added/updated counts; observe WAL growth; spot check post dates ≥ `since`.
- Web:
  - Toggle modes; trigger date-based sync; observe success toast and server response; retry on error.
